      ...
      <Link
        ...
        className={clsx(
          ...
          isActive
            ...
            : 'hover:text-violet-700 dark:hover:text-violet-600'
        )}
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-violet-700/0 via-violet-700/40 to-violet-700/0 dark:from-violet-600/0 dark:via-violet-600/40 dark:to-violet-600/0" />
        )}
      </Link>
    </li>
  )
...
function ModeToggle() {
  ...
  return (
    <button
      ...
      onClick={toggleMode}
    >
      <SunIcon className="h-6 w-6 fill-zinc-100 stroke-zinc-500 transition group-hover:fill-zinc-200 group-hover:stroke-zinc-700 dark:hidden [@media(prefers-color-scheme:dark)]:fill-violet-50 [@media(prefers-color-scheme:dark)]:stroke-violet-700 [@media(prefers-color-scheme:dark)]:group-hover:fill-violet-50 [@media(prefers-color-scheme:dark)]:group-hover:stroke-violet-700" />
